...
from Agents.TD3HERAgent import TD3HERAgent

# Module logger
logger = getModuleLogger(__name__)

def MakeTD3HERPEH2VEH2(session, env, args):
    ...
    if args.normalize_states:
        with tf.variable_scope('state_rms'):
            state_rms = RunningMeanStd(shape=(env.observation_space.shape[0] + env.goal_space.shape[0],))
    else:
        state_rms = None
...
if __name__ == "__main__":
    ...
    args.agent_name = "TD3HERPEH2VEH2"
